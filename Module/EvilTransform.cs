...
namespace MultiWiiWinGUI.Module
{
    ...
    public static class EvilTransform
    {
        ...
        /// <修改记录>
        /// 用户 : Administrator,修改时间 : 2015年11月19日 10:24:38
        /// </修改记录>
        /// <summary>
        /// 地球坐标到火星坐标
        /// </summary>
        /// <param name="wgsLat">The WGS lat.</param>
        /// <param name="wgsLng">The WGS LNG.</param>
        ...
        public static PointLatLng WGS2GCJ(PointLatLng point)
        {
            return WGS2GCJ(point.Lat, point.Lng);
        }

        /// <作者>Administrator</作者>
        /// <创建日期>2015年11月19日</创建日期>
        /// <修改记录>
        /// 用户 : Administrator,修改时间 : 2015年11月19日 10:13:39
        /// </修改记录>
        /// <summary>
        /// 火星坐标到地球坐标
        /// </summary>
        /// <param name="gcjLat">The GCJ lat.</param>
        /// <param name="gcjLng">The GCJ LNG.</param>
        /// <returns>PointLatLng.</returns>
        ...
        public static PointLatLng GCJ2WGS(PointLatLng point)
        {
            return GCJ2WGS(point.Lat, point.Lng);
        }
